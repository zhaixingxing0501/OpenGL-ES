...
//顶点着色函数
vertex RasterizerData1
vertexShader1(uint vertexID [[vertex_id]],
             constant ZXVertex1 *vertexArray [[buffer(ZXVertexInputIndexVertices)]],
             constant vector_uint2 *viewportSizePointer [[buffer(ZXVertexInputIndexViewportSize)]])
{
    /*
     处理顶点数据:
...
fragment float4 fragmentShader1(RasterizerData1 in [[stage_in]],
                               texture2d<half> colorTexture [[texture(ZXTextureIndexBaseColor)]])
{
